...
function UISimCombatInfoPanel:OnClickSimCombat(simType, unlockType)
  ...
  if simType == 1 then
    UIManager.OpenUI(UIDef.UISimCombatDailyPanel)
  elseif simType == 2 then
    UIManager.OpenUI(UIDef.UISimCombatRunesPanel)
  elseif simType == 3 then
    UIManager.OpenUI(UIDef.UISimCombatTrainingPanel)
  elseif simType == 4 then
    UIManager.OpenUI(UIDef.UIWeeklyEnterPanel)
  elseif simType == 5 then
    UIManager.OpenUI(UIDef.UISimCombatMythicMainPanel)
  end
end
