...
function UAVChrSkillDescriptionItem:InitData(skilllevelid, armlevel, index)
  ...
  self.mText_LevelNum.text = TableData.GetHintReplaceById(102111, string.sub(tostring(skilllevelid), 4, 4))
  self.mText_LevelDes.text = armskilltabledata.UpgradeDescription.str
