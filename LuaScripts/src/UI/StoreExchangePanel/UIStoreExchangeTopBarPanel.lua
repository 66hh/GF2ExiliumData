...
function UIStoreExchangeTopBarPanel:ctor(csPanel)
  UIStoreExchangeTopBarPanel.super.ctor(self, csPanel)
...
function UIStoreExchangeTopBarPanel:OnInit(root, data)
...
function UIStoreExchangeTopBarPanel:OnClose()
  self = UIStoreExchangeTopBarPanel
