...
UICommonWeaponBriefItem.ShowType = {Item = 1, Weapon = 2}
...
function UICommonWeaponBriefItem:UpdateWeapon()
  ...
  self.mText_WeaponLv.text = string_format(UIWeaponGlobal.WeaponLvRichText, self.data.Level, self.data.MaxLevel)
