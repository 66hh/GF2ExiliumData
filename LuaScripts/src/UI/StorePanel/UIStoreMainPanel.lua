...
UIStoreMainPanel.E3DModelType = gfenum({
  "eUnkown",
  "eGun",
  "eWeapon",
  "eEffect",
...
function UIStoreMainPanel.OnUpdateTop(data)
  self = UIStoreMainPanel
  self.mData = data
...
function UIStoreMainPanel.UpdateAffectionBar(npcData)
  ...
  CS.ProgressBarAnimationHelper.Play(self.mView.mImage_AffectionFilledBar, start_level, end_level, duration, function(curLv)
