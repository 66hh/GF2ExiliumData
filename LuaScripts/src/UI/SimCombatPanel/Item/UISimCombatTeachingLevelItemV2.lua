...
UISimCombatTeachingLevelItemV2.OrangeColor = Color(0.9647058823529412, 0.44313725490196076, 0.09803921568627451, 1.0)
...
function UISimCombatTeachingLevelItemV2:SetData(data)
  if data then
    ...
    self.mText_Num.text = data.StcData.number.str
