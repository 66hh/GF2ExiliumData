...
UISimCombatGoldChapterSelListItemV2.OrangeColor = Color(0.9647058823529412, 0.44313725490196076, 0.09803921568627451, 1.0)
...
function UISimCombatGoldChapterSelListItemV2:SetData(data, typeData, isLastItem)
  if data then
    ...
    self.mText_Chapter.text = data.number.str
